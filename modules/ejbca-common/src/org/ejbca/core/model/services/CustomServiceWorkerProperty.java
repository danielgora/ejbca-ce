...
public class CustomServiceWorkerProperty {
    ...
    private final HashMap<String, String> enabledWhenControlHasValue = new HashMap<>();

    public void enableWhenControlHasValue(CustomServiceWorkerProperty controllingControl, String value) {
        enabledWhenControlHasValue.put(controllingControl.enabledGroupId, Base64.getEncoder().encodeToString(value.getBytes()));
    }
     ...
     */
    public CustomServiceWorkerProperty(final String name, final int type, final List<String> options, final List<String> optionTexts,
            final String value) {
        this.name = name;
        this.type = type;
    ...
    public String getCssClass() {
        if (enabledWhenControlHasValue.isEmpty()) {
            ...
            return enabledWhenControlHasValue.keySet().stream().map(c -> "enable-" + c + " enable-" + c + "-" + enabledWhenControlHasValue.get(c))
